...
  <!-- SW-Killer + Firefox-Fixes -->

  <script>

    (function() {

      // Service Worker Cache leeren (verhindert Neocities-Cache-Bug)
...
  <div class="intro-strip" id="introStrip">

    <button class="intro-toggle" id="introToggle" aria-expanded="false" type="button">

      <span class="intro-tagline">

        <span class="intro-icon" aria-hidden="true">✦</span>

        Pythagoreische Numerologie · <strong>36 Kennzahlen</strong> · Name &amp; Geburtsdatum

      </span>

      <span class="intro-caret" aria-hidden="true">Was ist das?</span>

    </button>

    <div class="intro-details" id="introDetails" hidden>

      <p><strong>Numerologie</strong> ist die Lehre der Beziehung zwischen Zahlen und Lebensereignissen. Jeder Buchstabe deines Namens und jede Ziffer deines Geburtsdatums wird einer Zahl 1–9 zugeordnet.</p>

      <p>Dieses Tool nutzt das <strong>pythagoreische System</strong> – das weltweit bekannteste Numerologie-System – mit der präzisen <strong>Y-Vokal-Regel</strong>, der <strong>Komponenten-Methode</strong> für den Lebensweg und einer vollständigen <strong>Lo-Shu Psychomatrix</strong>.</p>

      <p class="intro-trust"><span>✓ Keine Datenspeicherung</span><span>✓ Alle Berechnungen lokal</span><span>✓ Quelloffen &amp; kostenlos</span></p>
...
                <span class="btn-icon btn-spinner-wrap" aria-hidden="true">✦</span>Berechnen
...
            <button class="btn btn--ghost" id="printBtn" type="button" aria-label="Drucken">🖨</button>
...
        <p class="results-hint" id="resultsHint">✦ Tippe auf eine Zahl für die vollständige Deutung</p>
...
    <!-- SHARE BAR (erscheint nach Berechnung) -->

    <div class="container container--full v1-bar-wrap" id="shareBarWrap" hidden>

      <div class="share-bar" id="shareBar">

        <p class="share-bar-text" id="shareBarText">Berechne dein Ergebnis um es zu teilen</p>

        <div class="share-bar-actions">

          <button class="btn btn--wa" id="shareBtnWA" type="button">

            <svg class="wa-icon" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>

            WhatsApp teilen

          </button>

          <button class="btn btn--ghost share-copy-btn" id="shareBtnCopy" type="button">

            <span id="shareCopyIcon">🔗</span> Link kopieren
...
    <!-- CTA BAR (erscheint nach Berechnung) -->

    <div class="container container--full v1-bar-wrap" id="ctaBarWrap" hidden>

      <div class="cta-bar">

        <p class="cta-bar-label">Mehr erkunden</p>

        <div class="cta-bar-actions">

          <button class="btn btn--cta-ghost" id="ctaBtnReset" type="button">

            ↺ Anderen Namen testen

          </button>

          <button class="btn btn--cta-ghost" id="ctaBtnCompare" type="button">
