...
  /* Firefox-Fallback: solider Hintergrund wenn backdrop-filter nicht unterstützt */

  @supports not (backdrop-filter: blur(1px)) { background: var(--card-bg-1); }
...
/* Hover-Ring für klickbare Tiles */

.result-tile[data-modal-type]:hover { outline: 1px solid rgba(114, 82, 168, 0.18); }

.result-tile.is-visible { animation: tileIn 0.38s var(--ease) forwards; }

/* Klickbarkeit per CSS — sichtbar vor JS-Ausführung */
...
  line-height: 1.4; min-height: 16px; opacity: 0.78;
...
/* Firefox: detail-modal Fallback-Hintergrund */

@-moz-document url-prefix() {

  .detail-modal { background: rgba(12, 12, 20, 0.99) !important; }
...
   27  INTRO STRIP — Was ist Numerologie?
...
  background: rgba(114, 82, 168, 0.045);

  border: 1px solid rgba(114, 82, 168, 0.12);

  border-radius: var(--r-md); cursor: pointer;

  font-family: var(--f-body); font-size: 0.78rem; color: var(--text-mid);
...
.intro-toggle:hover { background: rgba(114,82,168,0.07); border-color: rgba(114,82,168,0.20); }

[data-theme="light"] .intro-toggle { background: rgba(90,62,144,0.04); border-color: rgba(90,62,144,0.12); }

  

.intro-tagline {

  display: flex; align-items: center; gap: 8px; text-align: left; flex: 1;

}

.intro-tagline strong { color: var(--text); font-weight: 600; }

.intro-icon { color: var(--accent); opacity: 0.7; font-size: 0.8rem; flex-shrink: 0; }

  

.intro-caret {

  font-size: 0.72rem; color: var(--accent); opacity: 0.65;
...
.intro-toggle[aria-expanded="true"] .intro-caret { opacity: 0.4; }
...
  background: rgba(114,82,168,0.03);

  border: 1px solid rgba(114,82,168,0.10);
...
[data-theme="light"] .intro-details { background: rgba(90,62,144,0.03); border-color: rgba(90,62,144,0.10); }

.intro-details p {

  font-size: 0.82rem; color: var(--text-mid); line-height: 1.6; margin: 0;

}

.intro-details p strong { color: var(--text); font-weight: 600; }

.intro-trust {

  display: flex; gap: 16px; flex-wrap: wrap; padding-top: 6px;

  border-top: 1px solid rgba(255,255,255,0.04);

}

[data-theme="light"] .intro-trust { border-color: rgba(0,0,0,0.06); }

.intro-trust span {

  font-size: 0.72rem; color: var(--accent); opacity: 0.60;
...
   28  CALCULATE BUTTON — LOADING STATE
...
  background: rgba(114, 82, 168, 0.12) !important;

}

.btn--calculating .btn-spinner-wrap {
...
   29  CORE TILE IMPROVEMENTS

   ================================================================ */

  

/* Short keyword explanation — make clearly readable */

.life-number .result-explanation,

.expression-number .result-explanation,

.soul-number .result-explanation,

.personality-number .result-explanation {
...
/* Teaser text — one sentence from extended description */

.result-teaser {

  font-size: 0.71rem; font-weight: 300; color: var(--text-mid);

  text-align: center; line-height: 1.5; margin-top: 8px;

  padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.042);
...
/* Tap hint on core tiles */

.tile-tap-hint {

  position: absolute; bottom: 8px; right: 10px;

  font-size: 0.58rem; color: var(--accent); opacity: 0;
...
.v1-bar-wrap { animation: tileIn 0.40s var(--ease) both; }
...
  background: linear-gradient(135deg, rgba(114,82,168,0.07), rgba(80,55,140,0.04));

  border: 1px solid rgba(114,82,168,0.18);
...
  background: linear-gradient(135deg, rgba(90,62,144,0.06), rgba(60,40,120,0.03));

  border-color: rgba(90,62,144,0.16);
...
  font-size: 0.84rem; color: var(--text); font-weight: 400;
...
.share-bar-text strong { color: var(--accent-bright); }
...
  flex: 1; min-height: 44px; padding: 11px 18px; max-width: 280px;
...
  transition: transform var(--t-s), box-shadow var(--t-s), background var(--t-s);

}

.btn--wa:hover { background: #1e7a3e; transform: translateY(-2px); box-shadow: 0 6px 24px rgba(26,99,52,0.35); }
...
.share-copy-btn { flex: 1; max-width: 180px; min-height: 44px; }

.share-copy-btn.copied { color: #4caf80; border-color: rgba(76,175,80,0.35); }
...
  gap: 7px; padding: 10px 20px; min-height: 40px;
...
  background: rgba(114,82,168,0.06); transform: translateY(-1px);

}

[data-theme="light"] .btn--cta-ghost { background: rgba(0,0,0,0.024); }
...
  background: rgba(114,82,168,0.05);
...
  background: rgba(90,62,144,0.06); border-color: rgba(90,62,144,0.14);
...
  .btn--wa, .share-copy-btn { max-width: none; }

  .intro-tagline { font-size: 0.72rem; }
...
  .intro-strip, .share-bar, .cta-bar,

  .v1-bar-wrap, .share-bar-actions { display: none !important; }
