...
   25  LO-SHU PSYCHOMATRIX (NEU v3.0)
...
.lo-shu-cell--missing .lo-shu-num { color: var(--danger); opacity: 0.6; }

.lo-shu-cell--strong  .lo-shu-num { color: var(--gold-bright); }
...
.lo-shu-cell--strong  .lo-shu-dots { color: var(--gold-bright); }
...
[data-theme="light"] .modal-lo-shu-cell {
...
[data-theme="light"] .modal-lo-shu-info { background: rgba(0,0,0,0.025); }

.modal-lo-shu-info--missing { border-color: rgba(224,112,112,0.25); }

.modal-lo-shu-info--strong  { border-color: var(--gold-border); }

.modal-lo-shu-info--lines   { border-color: rgba(40,201,138,0.25); }
...
   26  QUANTUM SCORE TILE (NEU v3.0)
...
[data-theme="light"] .quantum-bar-track {
