/* style.css v1.5.8 - Erweiterung für Erklärungstexte unter jeder Zahl */
...
/* Results grid: ensure equal-height layout */
.results-grid{
    display:grid;
...
/* Extra numbers grid: dashed border hint */
