/* style.css v1.5.7 - Fokus: lesbare Erklärung, Masterzahlen, skalierbar */
...
/* Header */
h1 { margin:0 0 18px; font-size:1.5rem; letter-spacing:0.2px; color: var(--text); }
...
.tooltip:hover::after,
.tooltip:focus::after{ opacity:1; transform: translateX(-50%) translateY(0); }

/* extraNumbersGrid */
#extraNumbersGrid .result-tile{ border-style:dashed; opacity:0.95; }
