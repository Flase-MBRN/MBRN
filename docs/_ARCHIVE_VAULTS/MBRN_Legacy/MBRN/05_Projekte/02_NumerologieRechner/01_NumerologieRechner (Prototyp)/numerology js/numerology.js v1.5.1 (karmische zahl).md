/* numerology.js v1.5.1 - Erste Extra-Zahl: Karmische Zahl */
...
// --- Neue Extra-Zahlen: Karmische Zahl ---
function calculateKarmicNumber(expressionNumber){
    // klassische karmische Zahl: 1–9, Werte die in der ExpressionNumber fehlen
    const allNumbers = [1,2,3,4,5,6,7,8,9];
    const missingNumbers = allNumbers.filter(n => n !== expressionNumber);
    // Summe der fehlenden Zahlen modulo 9 (oder Master 11,22,33)
