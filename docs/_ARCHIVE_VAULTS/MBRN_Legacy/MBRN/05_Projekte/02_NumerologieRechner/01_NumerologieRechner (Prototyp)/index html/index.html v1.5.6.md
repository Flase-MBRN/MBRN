...
<body>
        ...
        <form id="numerologyForm" novalidate autocomplete="on">
          <fieldset style="border:0;padding:0;margin:0">
            ...
            <div class="input-row">
              ...
              <input type="text" id="name" name="name" autocomplete="name" inputmode="text" placeholder="Vorname Nachname" title="Gib deinen vollen Namen ein (Umlaute werden automatisch behandelt)">
      ...
      <aside class="results-card" aria-labelledby="results-title" role="region">
        ...
        <div class="results-grid" id="resultsGrid" role="list" aria-live="polite" aria-relevant="additions text">
          ...
          <div class="result-tile life-number" id="lifeTile" data-priority="1" role="listitem" aria-label="Lebenszahl">
            <div class="result-title"><span>Lebenszahl</span><button class="tooltip" title="Die Lebenszahl zeigt den Lebensweg und die grundlegenden Eigenschaften.">ℹ️</button></div>
          ...
          <div class="result-tile soul-number" id="soulTile" data-priority="2" role="listitem" aria-label="Seelenzahl">
            <div class="result-title"><span>Seelenzahl</span><button class="tooltip" title="Die Seelenzahl zeigt das innere Bedürfnis, Emotionen und Motivation.">ℹ️</button></div>
          ...
          <div class="result-tile expression-number" id="expressionTile" data-priority="3" role="listitem" aria-label="Ausdruckszahl">
            <div class="result-title"><span>Ausdruckszahl</span><button class="tooltip" title="Die Ausdruckszahl beschreibt wie andere dich wahrnehmen.">ℹ️</button></div>
          ...
          <div class="result-tile personality-number" id="personalityTile" data-priority="4" role="listitem" aria-label="Persönlichkeitszahl">
            <div class="result-title"><span>Persönlichkeitszahl</span><button class="tooltip" title="Persönlichkeitszahl: zeigt, wie andere dich sehen.">ℹ️</button></div>
        ...
        <div class="results-grid" id="extraNumbersGrid" aria-hidden="false" aria-live="polite"></div>
      </aside>
    </div>
  </main>

  <footer class="footer" role="contentinfo">
    <small>v1.5.6 — inklusive Erklärungen, skalierbar</small>
  </footer>
  ...
  <style>
    ...
    .result-explanation { font-size:0.85rem; color:#aab3c0; margin-top:4px; text-align:center; min-height:20px; }
  </style>
</body>
</html>