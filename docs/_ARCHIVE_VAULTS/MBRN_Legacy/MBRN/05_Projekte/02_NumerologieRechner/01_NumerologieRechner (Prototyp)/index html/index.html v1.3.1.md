...
<head>
    <meta charset="UTF-8">
    <title>Numerologie-Rechner v1.3.1</title>
    <link rel="stylesheet" href="style.css">
    <script src="numerology.js"></script>
</head>
<body>
    <h1>Numerologie-Rechner v1.3.1</h1>
    ...
    <div class="container">
        ...
        <div class="results-card">
            ...
            <div class="results-grid" id="resultsGrid">
                <!-- Lebenszahl -->
                <div class="result-tile" id="lifeTile">
                ...
                <!-- Seelenzahl -->
                <div class="result-tile" id="soulTile">
                ...
                <!-- Ausdruckszahl -->
                <div class="result-tile" id="expressionTile">
                ...
                <!-- Persönlichkeitszahl -->
                <div class="result-tile" id="personalityTile">
