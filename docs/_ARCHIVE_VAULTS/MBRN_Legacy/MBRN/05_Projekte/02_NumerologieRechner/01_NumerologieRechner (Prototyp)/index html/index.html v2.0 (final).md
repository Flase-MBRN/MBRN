...
  <meta name="description" content="Numerologie-Rechner v2.0 – Lebenszahl, Seelenzahl, Herausforderungen, Höhepunkte und mehr.">
...
  <title>Numerologie-Rechner v2.0</title>
...
  <!-- SW-Killer: läuft vor allem anderen, räumt jeden alten Cache weg -->
...
      // Alle registrierten SWs deregistrieren
...
              <button class="tooltip-btn" type="button" aria-label="Info" data-tooltip="Dein Lebensweg — die wichtigste Zahl der Pythagoras-Numerologie.">ℹ</button>
...
              <button class="tooltip-btn" type="button" aria-label="Info" data-tooltip="Dein innerstes Bedürfnis — was deine Seele wirklich anstrebt.">ℹ</button>
...
              <button class="tooltip-btn" type="button" aria-label="Info" data-tooltip="Wie andere dich auf den ersten Blick wahrnehmen — deine äußere Hülle.">ℹ</button>
...
                <input type="text" id="compareDate1" inputmode="text" placeholder="TT.MM.JJJJ">
...
                <input type="text" id="compareDate2" inputmode="text" placeholder="TT.MM.JJJJ">
...
      Numerologie-Rechner v2.0 — Lebenszahl · Ausdruckszahl · Seelenzahl · Persönlichkeit · 32 Zahlen
