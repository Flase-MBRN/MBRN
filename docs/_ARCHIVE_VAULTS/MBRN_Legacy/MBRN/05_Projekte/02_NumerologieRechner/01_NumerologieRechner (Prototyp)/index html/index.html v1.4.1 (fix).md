...
<head>
  ...
  <title>Numerologie-Rechner v1.4.1</title>
  <link rel="stylesheet" href="style.css">
  <!-- Script loaded with defer to avoid blocking and to be compatible with DOMContentLoaded wrapper -->
  <script src="numerology.js" defer></script>
</head>
<body>
  <header role="banner" aria-label="Numerologie Rechner">
    <h1>Numerologie-Rechner v1.4.1</h1>
  </header>
  ...
  <main role="main" class="content" aria-labelledby="main-title">
    <div class="container">
      ...
      <section class="form-card" aria-labelledby="form-title">
        ...
        <!-- Use novalidate to rely on our JS validation -->
        ...
        <div class="results-grid" id="resultsGrid" role="list" aria-live="polite" aria-relevant="additions text">
          ...
          <div class="result-tile expression-number" id="expressionTile" data-priority="3" role="listitem" aria-label="Ausdruckszahl">
            <div class="result-title">
              ...
              <button class="tooltip" title="Ausdruckszahl: Summe aller Buchstaben deines Namens (zeigt Ausdruck/Stil).">ℹ️</button>
            </div>
            <div class="result-value" id="expressionNumber" role="status" aria-atomic="true" data-number-type="expression"></div>
          </div>

          <!-- Persönlichkeitszahl (priority 4) -->
          <div class="result-tile personality-number" id="personalityTile" data-priority="4" role="listitem" aria-label="Persönlichkeitszahl">
            <div class="result-title">
              ...
              <button class="tooltip" title="Persönlichkeitszahl: Summe der Konsonanten (wie andere dich wahrnehmen).">ℹ️</button>
            </div>
            <div class="result-value" id="personalityNumber" role="status" aria-atomic="true" data-number-type="personality"></div>
          </div>
        </div>

        <!-- Extra numbers grid — dynamisch befüllbar -->
  ...
  <footer class="footer" role="contentinfo">
    <small>v1.4.1 — skalierbare Basis für weitere Numerologie-Features</small>
  </footer>

  <!-- Small helper stylesheet for screen-reader-only utility (no external change required) -->
  <style>
