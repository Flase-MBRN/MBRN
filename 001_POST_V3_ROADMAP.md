...
- `frontend_os`: clear_responsibility, active_modules, clear_contracts, no_distributed_shadow_logic
- `oracle`: clear_responsibility, active_modules, clear_contracts, no_distributed_shadow_logic
- `monetization`: clear_responsibility, active_modules, clear_contracts, no_distributed_shadow_logic
- `meta_generator`: clear_responsibility, active_modules, clear_contracts, no_distributed_shadow_logic
